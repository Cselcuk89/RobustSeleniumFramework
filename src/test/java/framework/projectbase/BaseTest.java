package framework.projectbase;

import framework.frameworkfactory.abstractFactory.DriverManagerAbstract;
import framework.frameworkfactory.abstractFactory.DriverManagerFactoryAbstract;
import framework.frameworkutils.CookieHelper;
...
//            takeScreenshot(destFile);
    ...
    public void injectCookiesToBrowser(Cookies cookies) {
        List<org.openqa.selenium.Cookie> seleniumCookies = new CookieHelper().convertRestAssuredCookiesToSeleniumCookies(cookies);
